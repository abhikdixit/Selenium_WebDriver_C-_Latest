...
namespace SeleniumTests
{
    ...
    public class GoogleSearchTests
    {
        ...
        [Test]
        [Category("Smoke")]
        public void LoginToWeborders_Smoke()
        {
            // Navigate to Google
            ...
            wait.Until(d => d.FindElement(By.CssSelector("ul[role='listbox'] li")));

            // Capture all auto-suggestions
            var suggestionElements = driver.FindElements(By.CssSelector("ul[role='listbox'] li span"));
